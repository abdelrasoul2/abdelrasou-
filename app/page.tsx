  ...
  return (
    <div className="flex flex-col min-h-screen" dir={dir}>
      ...
      <main className="flex-1">
                            ...
                            return (
                              <div
                                ...
                                className={`aspect-square rounded-full flex items-center justify-center text-white font-bold ${
                                  ["bg-orange-500", "bg-orange-600", "bg-orange-400", "bg-amber-500", "bg-amber-600"][
                                    i % 5
                                  ]
                                }`}
                                style={{
        ...
        {/* Ad Unit after hero section with fixed dimensions */}
        ...
        {/* Ad Unit before CTA section with fixed dimensions */}
        <div className="container my-8 flex justify-center">
